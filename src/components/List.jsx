...
export default function List({ list, index, createCard, deleteCard, updateCard }) {
  ...
  return (
    <Draggable draggableId={`list-${list.id}`} index={index}>
      ...
      <div ref={provided.innerRef}
            {...provided.draggableProps} className="w-72 shrink-0 bg-[#101204] rounded-xl p-3 text-gray-300 h-fit max-h-full flex flex-col shadow-md border border-gray-800">
        
        <div
        {...provided.dragHandleProps} className="font-bold text-sm mb-2 px-2 flex justify-between items-center">
          {list.title}
